...
class PhotoController extends Controller
{
    ...
    {
        $items = Portfolio::where('type','photo')->latest('created_at')->get();

        return view('admin.photo.index', compact('items'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route(ADMIN . '.photo.index')->withSuccess(trans('app.success_store'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route(ADMIN . '.photo.index')->withSuccess(trans('app.success_update'));
    }
